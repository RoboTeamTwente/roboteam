...
typedef struct _REM_RobotStateInfo {
    ...
    float      dribbleSpeed        ; // float   [0.000, 20000.000]   dribblerSpeed
    float      filteredDribbleSpeed; // float   [0.000, 20000.000]   filtered dribblerSpeed
    float      dribblespeedBeforeGotBall; // float   [0.000, 20000.000]   dribblerSpeed at at the time dribbler thinks it got the ball
...
static inline float REM_RobotStateInfo_get_dribbleSpeed(REM_RobotStateInfoPayload *remrsip){
    uint32_t _dribbleSpeed = ((remrsip->payload[34] & 0b00001111) << 12) | ((remrsip->payload[35]) << 4) | ((remrsip->payload[36] & 0b11110000) >> 4);
    return (_dribbleSpeed * 0.3051804379339285) + 0.0000000000000000;
}

static inline float REM_RobotStateInfo_get_filteredDribbleSpeed(REM_RobotStateInfoPayload *remrsip){
    uint32_t _filteredDribbleSpeed = ((remrsip->payload[36] & 0b00001111) << 12) | ((remrsip->payload[37]) << 4) | ((remrsip->payload[38] & 0b11110000) >> 4);
    return (_filteredDribbleSpeed * 0.3051804379339285) + 0.0000000000000000;
}

static inline float REM_RobotStateInfo_get_dribblespeedBeforeGotBall(REM_RobotStateInfoPayload *remrsip){
    uint32_t _dribblespeedBeforeGotBall = ((remrsip->payload[38] & 0b00001111) << 12) | ((remrsip->payload[39]) << 4) | ((remrsip->payload[40] & 0b11110000) >> 4);
    return (_dribblespeedBeforeGotBall * 0.3051804379339285) + 0.0000000000000000;
}

static inline float REM_RobotStateInfo_get_bodyXIntegral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _bodyXIntegral = ((remrsip->payload[40] & 0b00001111) << 28) | ((remrsip->payload[41]) << 20) | ((remrsip->payload[42]) << 12) | ((remrsip->payload[43]) << 4) | ((remrsip->payload[44] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_bodyYIntegral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _bodyYIntegral = ((remrsip->payload[44] & 0b00001111) << 28) | ((remrsip->payload[45]) << 20) | ((remrsip->payload[46]) << 12) | ((remrsip->payload[47]) << 4) | ((remrsip->payload[48] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_bodyWIntegral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _bodyWIntegral = ((remrsip->payload[48] & 0b00001111) << 28) | ((remrsip->payload[49]) << 20) | ((remrsip->payload[50]) << 12) | ((remrsip->payload[51]) << 4) | ((remrsip->payload[52] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_bodyYawIntegral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _bodyYawIntegral = ((remrsip->payload[52] & 0b00001111) << 28) | ((remrsip->payload[53]) << 20) | ((remrsip->payload[54]) << 12) | ((remrsip->payload[55]) << 4) | ((remrsip->payload[56] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_wheel1Integral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _wheel1Integral = ((remrsip->payload[56] & 0b00001111) << 28) | ((remrsip->payload[57]) << 20) | ((remrsip->payload[58]) << 12) | ((remrsip->payload[59]) << 4) | ((remrsip->payload[60] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_wheel2Integral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _wheel2Integral = ((remrsip->payload[60] & 0b00001111) << 28) | ((remrsip->payload[61]) << 20) | ((remrsip->payload[62]) << 12) | ((remrsip->payload[63]) << 4) | ((remrsip->payload[64] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_wheel3Integral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _wheel3Integral = ((remrsip->payload[64] & 0b00001111) << 28) | ((remrsip->payload[65]) << 20) | ((remrsip->payload[66]) << 12) | ((remrsip->payload[67]) << 4) | ((remrsip->payload[68] & 0b11110000) >> 4);
...
static inline float REM_RobotStateInfo_get_wheel4Integral(REM_RobotStateInfoPayload *remrsip){
    uint32_t _wheel4Integral = ((remrsip->payload[68] & 0b00001111) << 28) | ((remrsip->payload[69]) << 20) | ((remrsip->payload[70]) << 12) | ((remrsip->payload[71]) << 4) | ((remrsip->payload[72] & 0b11110000) >> 4);
...
static inline void REM_RobotStateInfo_set_dribbleSpeed(REM_RobotStateInfoPayload *remrsip, float dribbleSpeed){
    uint32_t _dribbleSpeed = (uint32_t)(dribbleSpeed / 0.3051804379339285);
    remrsip->payload[34] = ((_dribbleSpeed >> 12) & 0b00001111) | (remrsip->payload[34] & 0b11110000);
    remrsip->payload[35] = (_dribbleSpeed >> 4);
    remrsip->payload[36] = ((_dribbleSpeed << 4) & 0b11110000) | (remrsip->payload[36] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_filteredDribbleSpeed(REM_RobotStateInfoPayload *remrsip, float filteredDribbleSpeed){
    uint32_t _filteredDribbleSpeed = (uint32_t)(filteredDribbleSpeed / 0.3051804379339285);
    remrsip->payload[36] = ((_filteredDribbleSpeed >> 12) & 0b00001111) | (remrsip->payload[36] & 0b11110000);
    remrsip->payload[37] = (_filteredDribbleSpeed >> 4);
    remrsip->payload[38] = ((_filteredDribbleSpeed << 4) & 0b11110000) | (remrsip->payload[38] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_dribblespeedBeforeGotBall(REM_RobotStateInfoPayload *remrsip, float dribblespeedBeforeGotBall){
    uint32_t _dribblespeedBeforeGotBall = (uint32_t)(dribblespeedBeforeGotBall / 0.3051804379339285);
    remrsip->payload[38] = ((_dribblespeedBeforeGotBall >> 12) & 0b00001111) | (remrsip->payload[38] & 0b11110000);
    remrsip->payload[39] = (_dribblespeedBeforeGotBall >> 4);
    remrsip->payload[40] = ((_dribblespeedBeforeGotBall << 4) & 0b11110000) | (remrsip->payload[40] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_bodyXIntegral(REM_RobotStateInfoPayload *remrsip, float bodyXIntegral){
    ...
    remrsip->payload[40] = ((_bodyXIntegral >> 28) & 0b00001111) | (remrsip->payload[40] & 0b11110000);
    remrsip->payload[41] = (_bodyXIntegral >> 20);
    remrsip->payload[42] = (_bodyXIntegral >> 12);
    remrsip->payload[43] = (_bodyXIntegral >> 4);
    remrsip->payload[44] = ((_bodyXIntegral << 4) & 0b11110000) | (remrsip->payload[44] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_bodyYIntegral(REM_RobotStateInfoPayload *remrsip, float bodyYIntegral){
    ...
    remrsip->payload[44] = ((_bodyYIntegral >> 28) & 0b00001111) | (remrsip->payload[44] & 0b11110000);
    remrsip->payload[45] = (_bodyYIntegral >> 20);
    remrsip->payload[46] = (_bodyYIntegral >> 12);
    remrsip->payload[47] = (_bodyYIntegral >> 4);
    remrsip->payload[48] = ((_bodyYIntegral << 4) & 0b11110000) | (remrsip->payload[48] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_bodyWIntegral(REM_RobotStateInfoPayload *remrsip, float bodyWIntegral){
    ...
    remrsip->payload[48] = ((_bodyWIntegral >> 28) & 0b00001111) | (remrsip->payload[48] & 0b11110000);
    remrsip->payload[49] = (_bodyWIntegral >> 20);
    remrsip->payload[50] = (_bodyWIntegral >> 12);
    remrsip->payload[51] = (_bodyWIntegral >> 4);
    remrsip->payload[52] = ((_bodyWIntegral << 4) & 0b11110000) | (remrsip->payload[52] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_bodyYawIntegral(REM_RobotStateInfoPayload *remrsip, float bodyYawIntegral){
    ...
    remrsip->payload[52] = ((_bodyYawIntegral >> 28) & 0b00001111) | (remrsip->payload[52] & 0b11110000);
    remrsip->payload[53] = (_bodyYawIntegral >> 20);
    remrsip->payload[54] = (_bodyYawIntegral >> 12);
    remrsip->payload[55] = (_bodyYawIntegral >> 4);
    remrsip->payload[56] = ((_bodyYawIntegral << 4) & 0b11110000) | (remrsip->payload[56] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_wheel1Integral(REM_RobotStateInfoPayload *remrsip, float wheel1Integral){
    ...
    remrsip->payload[56] = ((_wheel1Integral >> 28) & 0b00001111) | (remrsip->payload[56] & 0b11110000);
    remrsip->payload[57] = (_wheel1Integral >> 20);
    remrsip->payload[58] = (_wheel1Integral >> 12);
    remrsip->payload[59] = (_wheel1Integral >> 4);
    remrsip->payload[60] = ((_wheel1Integral << 4) & 0b11110000) | (remrsip->payload[60] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_wheel2Integral(REM_RobotStateInfoPayload *remrsip, float wheel2Integral){
    ...
    remrsip->payload[60] = ((_wheel2Integral >> 28) & 0b00001111) | (remrsip->payload[60] & 0b11110000);
    remrsip->payload[61] = (_wheel2Integral >> 20);
    remrsip->payload[62] = (_wheel2Integral >> 12);
    remrsip->payload[63] = (_wheel2Integral >> 4);
    remrsip->payload[64] = ((_wheel2Integral << 4) & 0b11110000) | (remrsip->payload[64] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_wheel3Integral(REM_RobotStateInfoPayload *remrsip, float wheel3Integral){
    ...
    remrsip->payload[64] = ((_wheel3Integral >> 28) & 0b00001111) | (remrsip->payload[64] & 0b11110000);
    remrsip->payload[65] = (_wheel3Integral >> 20);
    remrsip->payload[66] = (_wheel3Integral >> 12);
    remrsip->payload[67] = (_wheel3Integral >> 4);
    remrsip->payload[68] = ((_wheel3Integral << 4) & 0b11110000) | (remrsip->payload[68] & 0b00001111);
}
...
static inline void REM_RobotStateInfo_set_wheel4Integral(REM_RobotStateInfoPayload *remrsip, float wheel4Integral){
    ...
    remrsip->payload[68] = ((_wheel4Integral >> 28) & 0b00001111) | (remrsip->payload[68] & 0b11110000);
    remrsip->payload[69] = (_wheel4Integral >> 20);
    remrsip->payload[70] = (_wheel4Integral >> 12);
    remrsip->payload[71] = (_wheel4Integral >> 4);
    remrsip->payload[72] = ((_wheel4Integral << 4) & 0b11110000) | (remrsip->payload[72] & 0b00001111);
}
