...
// ================================ GETTERS ================================
static inline uint32_t REM_RobotSetPIDGains_get_header(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[0])); }

static inline uint32_t REM_RobotSetPIDGains_get_toRobotId(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[1] & 0b11110000) >> 4); }

static inline bool REM_RobotSetPIDGains_get_toColor(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[1] & 0b00001000) > 0; }

static inline bool REM_RobotSetPIDGains_get_toBC(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[1] & 0b00000100) > 0; }

static inline bool REM_RobotSetPIDGains_get_toBS(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[1] & 0b00000010) > 0; }

static inline bool REM_RobotSetPIDGains_get_toPC(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[1] & 0b00000001) > 0; }

static inline uint32_t REM_RobotSetPIDGains_get_fromRobotId(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[2] & 0b11110000) >> 4); }

static inline bool REM_RobotSetPIDGains_get_fromColor(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[2] & 0b00001000) > 0; }

static inline bool REM_RobotSetPIDGains_get_reserved(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[2] & 0b00000100) > 0; }

static inline bool REM_RobotSetPIDGains_get_fromBS(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[2] & 0b00000010) > 0; }

static inline bool REM_RobotSetPIDGains_get_fromPC(REM_RobotSetPIDGainsPayload *remrspidgp) { return (remrspidgp->payload[2] & 0b00000001) > 0; }

static inline uint32_t REM_RobotSetPIDGains_get_remVersion(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[3] & 0b11110000) >> 4); }

static inline uint32_t REM_RobotSetPIDGains_get_messageId(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[3] & 0b00001111)); }
...
static inline uint32_t REM_RobotSetPIDGains_get_payloadSize(REM_RobotSetPIDGainsPayload *remrspidgp) { return ((remrspidgp->payload[7])); }
...
// ================================ SETTERS ================================
static inline void REM_RobotSetPIDGains_set_header(REM_RobotSetPIDGainsPayload *remrspidgp, uint32_t header) { remrspidgp->payload[0] = header; }
...
static inline void REM_RobotSetPIDGains_set_payloadSize(REM_RobotSetPIDGainsPayload *remrspidgp, uint32_t payloadSize) { remrspidgp->payload[7] = payloadSize; }
