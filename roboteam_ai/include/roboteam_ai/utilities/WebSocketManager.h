...
//
//
//    void reportNumber(std::basic_string<char> label, double value);
//    void reportBoundedValue(std::basic_string<char> label, double value, double min, double max);
...
//    proto::MessageEnvelope metricsBufferEnvelope{};
//
