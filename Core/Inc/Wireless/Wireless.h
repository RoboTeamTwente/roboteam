...
#define WIRELESS_CHANNEL_YELLOW_ROBOT_TO_BASESTATION 94   // 2.4940 GHz
#define WIRELESS_CHANNEL_BLUE_ROBOT_TO_BASESTATION   95.5 // 2.4955 GHz
#define WIRELESS_CHANNEL_YELLOW_BASESTATION_TO_ROBOT 97   // 2.4970 GHz
#define WIRELESS_CHANNEL_BLUE_BASESTATION_TO_ROBOT   98.5 // 2.4985 GHz
