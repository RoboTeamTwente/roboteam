...
MTi_data_tuple data_configurations[]={
	{.ID = XDI_PacketCounter	, .frequency = 80	, .data = &MTi_struct.packetcounter	},
	{.ID = XDI_Acceleration		, .frequency = 80	, .data = MTi_struct.acc			},
	{.ID = XDI_StatusWord		, .frequency = 10	, .data = &MTi_struct.statusword	},
	{.ID = XDI_EulerAngles		, .frequency = 80	, .data = MTi_struct.angles			},
	{.ID = XDI_RateOfTurn		, .frequency = 80	, .data = MTi_struct.gyr			}
	};
