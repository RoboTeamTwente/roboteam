...
FormationPreHalf::FormationPreHalf() : Play() {
    ...
    roles = std::array<std::unique_ptr<Role>, rtt::ai::Constants::ROBOT_COUNT()>{
        std::make_unique<role::Formation>("keeper"),      std::make_unique<role::Formation>("formation_0"), std::make_unique<role::Formation>("formation_1"),
        std::make_unique<role::Formation>("formation_2"), std::make_unique<role::Formation>("formation_3"), std::make_unique<role::Formation>("formation_4"),
        std::make_unique<role::Formation>("formation_5"), std::make_unique<role::Formation>("formation_6"), std::make_unique<role::Formation>("formation_7"),
        std::make_unique<role::Formation>("formation_8"), std::make_unique<role::Formation>("formation_9")};
}
...
void FormationPreHalf::calculateInfoForRoles() noexcept {
    ...
    stpInfos["formation_0"].setPositionToMoveTo(Vector2(-width / 4, -height / 8));
    stpInfos["formation_1"].setPositionToMoveTo(Vector2(-width / 8, height / 4));
    stpInfos["formation_2"].setPositionToMoveTo(Vector2(-width / 8, -height / 4));
    stpInfos["formation_3"].setPositionToMoveTo(Vector2(defense_line_x, 0.0));
    stpInfos["formation_4"].setPositionToMoveTo(Vector2(defense_line_x, height / 5));
    stpInfos["formation_5"].setPositionToMoveTo(Vector2(defense_line_x, -height / 5));
    stpInfos["formation_6"].setPositionToMoveTo(Vector2(-width / 4, height / 3));
    stpInfos["formation_7"].setPositionToMoveTo(Vector2(-width / 4, -height / 3));
    stpInfos["formation_8"].setPositionToMoveTo(Vector2(-width * 3.0 / 16.0, 0.0));
}
