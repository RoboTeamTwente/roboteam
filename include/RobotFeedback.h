...
static inline void RobotFeedback_set_ballPos(RobotFeedbackPayload *rfp, float ballPos){
    ...
    rfp->payload[3] = ((_ballPos << 4) & 0b11110000) | (payload[3] & 0b00001111);
}

static inline void RobotFeedback_set_rho(RobotFeedbackPayload *rfp, float rho){
    _rho = int(rho / 0.0001220703125000)
    rfp->payload[3] = ((_rho >> 12) & 0b00001111) | (payload[3] & 0b11110000);
    rfp->payload[4] = (_rho >> 8);
    rfp->payload[5] = ((_rho >> 8) & 0b11110000) | (payload[5] & 0b00001111);
}
...
static inline void RobotFeedback_set_theta(RobotFeedbackPayload *rfp, float theta){
    ...
    rfp->payload[5] = ((_theta >> 12) & 0b00001111) | (payload[5] & 0b11110000);
    rfp->payload[6] = (_theta >> 8);
    rfp->payload[7] = ((_theta >> 8) & 0b11110000) | (payload[7] & 0b00001111);
}
