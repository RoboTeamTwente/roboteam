...
void ConfigurationCommand::addRobotLocation(int id, rtt::Team color, float x, float y, float xVelocity, float yVelocity, float angularVelocity, float orientation,
    ...
    tpRobotCommand->mutable_id()->set_team(color == rtt::Team::YELLOW ? proto::simulation::Team::YELLOW : proto::simulation::Team::BLUE);
...
void ConfigurationCommand::addRobotSpecs(int id, rtt::Team color, RobotProperties& robotProperties) {
    proto::simulation::RobotSpecs* specs = this->configurationCommand.mutable_config()->add_robot_specs();

    specs->mutable_id()->set_id(id);
    specs->mutable_id()->set_team(color == rtt::Team::YELLOW ? proto::simulation::Team::YELLOW : proto::simulation::Team::BLUE);
