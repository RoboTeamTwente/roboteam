...
typedef enum _PACKET_TYPE { 
    ...
    PACKET_TYPE_ROBOT_INTERNAL_SIGNAL          = 0b00110011,
    PACKET_TYPE_ROBOT_INTERNAL_INTERRUPT       = 0b00111100,
    PACKET_TYPE_ROBOT_INTERNAL_MESSAGE         = 0b01010101,
    // PACKET_TYPE_ROBOT_LOG                      = 0b01101001,
    // PACKET_TYPE_ROBOT_ALERT                    = 0b01011010,
    PACKET_TYPE_ROBOT_BUZZER                   = 0b01011010,
...
typedef enum _PACKET_SIZE { 
    ...
    PACKET_SIZE_ROBOT_INTERNAL_SIGNAL          = 0,
    PACKET_SIZE_ROBOT_INTERNAL_INTERRUPT       = 0,
