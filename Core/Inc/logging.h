...
/**
 * @brief logging.c Is simply a wrapper around a buffer, that stores messages and sends then out when possible
 * 
 ...
 * TODO : Support selecting output channels (SX1280, UART, SD-card?, ...)
 */
...
/**
 * @brief Send the next message over UART if UART is available 
 */
void LOG_send();
