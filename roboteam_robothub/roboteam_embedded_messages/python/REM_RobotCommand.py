...
# ================================ GETTERS ================================
    ...
    def get_useCameraAngle(payload):
        return (payload[17] & 0b10000000) > 0;

    @staticmethod
    def get_useAbsoluteAngle(payload):
        return (payload[17] & 0b01000000) > 0;
    ...
    def get_doChip(payload):
        return (payload[17] & 0b00000010) > 0;

    @staticmethod
    def get_kickAtAngle(payload):
        return (payload[17] & 0b00000001) > 0;
...
# ================================ SETTERS ================================
    ...
    def set_useCameraAngle(payload, useCameraAngle):
        payload[17] = ((useCameraAngle << 7) & 0b10000000) | (payload[17] & 0b01111111);

    @staticmethod
    def set_useAbsoluteAngle(payload, useAbsoluteAngle):
        payload[17] = ((useAbsoluteAngle << 6) & 0b01000000) | (payload[17] & 0b10111111);
    ...
    def set_doKick(payload, doKick):
        payload[17] = ((doKick << 2) & 0b00000100) | (payload[17] & 0b11111011);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[17] = ((doChip << 1) & 0b00000010) | (payload[17] & 0b11111101);

    @staticmethod
    def set_kickAtAngle(payload, kickAtAngle):
        payload[17] = (kickAtAngle & 0b00000001) | (payload[17] & 0b11111110);
    ...
    def set_doForce(payload, doForce):
        payload[18] = ((doForce << 3) & 0b00001000) | (payload[18] & 0b11110111);

    @staticmethod
    def set_feedback(payload, feedback):
        payload[18] = ((feedback << 2) & 0b00000100) | (payload[18] & 0b11111011);
