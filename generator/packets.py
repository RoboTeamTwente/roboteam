...
packets = {
    ...
    "BasestationStatistics" : [
        ...
        ["bot0_sent",  8, None, "Packets received from robot with ID 0"],
        ["bot1_sent",  8, None, "Packets sent to robot with ID 1"],
        ["bot1_sent",  8, None, "Packets received from robot with ID 1"],
        ["bot2_sent",  8, None, "Packets sent to robot with ID 2"],
        ["bot2_sent",  8, None, "Packets received from robot with ID 2"],
        ["bot3_sent",  8, None, "Packets sent to robot with ID 3"],
        ["bot3_sent",  8, None, "Packets received from robot with ID 3"],
        ["bot4_sent",  8, None, "Packets sent to robot with ID 4"],
        ["bot4_sent",  8, None, "Packets received from robot with ID 4"],
        ["bot5_sent",  8, None, "Packets sent to robot with ID 5"],
        ["bot5_sent",  8, None, "Packets received from robot with ID 5"],
        ["bot6_sent",  8, None, "Packets sent to robot with ID 6"],
        ["bot6_sent",  8, None, "Packets received from robot with ID 6"],
        ["bot7_sent",  8, None, "Packets sent to robot with ID 7"],
        ["bot7_sent",  8, None, "Packets received from robot with ID 7"],
        ["bot8_sent",  8, None, "Packets sent to robot with ID 8"],
        ["bot8_sent",  8, None, "Packets received from robot with ID 8"],
        ["bot9_sent",  8, None, "Packets sent to robot with ID 9"],
        ["bot9_sent",  8, None, "Packets received from robot with ID 9"],
        ["bot10_sent", 8, None, "Packets sent to robot with ID 10"],
        ["bot10_sent", 8, None, "Packets received from robot with ID 10"],
        ["bot11_sent", 8, None, "Packets sent to robot with ID 11"],
        ["bot11_sent", 8, None, "Packets received from robot with ID 11"],
        ["bot12_sent", 8, None, "Packets sent to robot with ID 12"],
        ["bot12_sent", 8, None, "Packets received from robot with ID 12"],
        ["bot13_sent", 8, None, "Packets sent to robot with ID 13"],
        ["bot13_sent", 8, None, "Packets received from robot with ID 13"],
        ["bot14_sent", 8, None, "Packets sent to robot with ID 14"],
        ["bot14_sent", 8, None, "Packets received from robot with ID 14"],
        ["bot15_sent", 8, None, "Packets sent to robot with ID 15"],
        ["bot15_sent", 8, None, "Packets received from robot with ID 15"]
    ]
}    