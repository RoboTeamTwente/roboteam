...
class REM_BasestationSetConfiguration:
...
# ================================ ENCODE ================================
    def encode(self):
        ...
        REM_BasestationSetConfiguration.set_toRobotId           (payload, self.toRobotId)
        REM_BasestationSetConfiguration.set_toColor             (payload, self.toColor)
        REM_BasestationSetConfiguration.set_toBC                (payload, self.toBC)
        REM_BasestationSetConfiguration.set_toBS                (payload, self.toBS)
        REM_BasestationSetConfiguration.set_toPC                (payload, self.toPC)
        REM_BasestationSetConfiguration.set_fromRobotId         (payload, self.fromRobotId)
        REM_BasestationSetConfiguration.set_fromColor           (payload, self.fromColor)
        REM_BasestationSetConfiguration.set_reserved            (payload, self.reserved)
        REM_BasestationSetConfiguration.set_fromBS              (payload, self.fromBS)
        REM_BasestationSetConfiguration.set_fromPC              (payload, self.fromPC)
        REM_BasestationSetConfiguration.set_remVersion          (payload, self.remVersion)
        REM_BasestationSetConfiguration.set_messageId           (payload, self.messageId)
        REM_BasestationSetConfiguration.set_payloadSize         (payload, self.payloadSize)
        REM_BasestationSetConfiguration.set_header              (payload, self.header)
        return payload
...
# ================================ DECODE ================================
    def decode(self, payload):
        self.header           = REM_BasestationSetConfiguration.get_header(payload)
        self.toRobotId        = REM_BasestationSetConfiguration.get_toRobotId(payload)
        self.toColor          = REM_BasestationSetConfiguration.get_toColor(payload)
        self.toBC             = REM_BasestationSetConfiguration.get_toBC(payload)
        self.toBS             = REM_BasestationSetConfiguration.get_toBS(payload)
        self.toPC             = REM_BasestationSetConfiguration.get_toPC(payload)
        self.fromRobotId      = REM_BasestationSetConfiguration.get_fromRobotId(payload)
        self.fromColor        = REM_BasestationSetConfiguration.get_fromColor(payload)
        self.reserved         = REM_BasestationSetConfiguration.get_reserved(payload)
        self.fromBS           = REM_BasestationSetConfiguration.get_fromBS(payload)
        self.fromPC           = REM_BasestationSetConfiguration.get_fromPC(payload)
        self.remVersion       = REM_BasestationSetConfiguration.get_remVersion(payload)
        self.messageId        = REM_BasestationSetConfiguration.get_messageId(payload)
        self.payloadSize      = REM_BasestationSetConfiguration.get_payloadSize(payload)
        self.header           = REM_BasestationSetConfiguration.get_header(payload)
