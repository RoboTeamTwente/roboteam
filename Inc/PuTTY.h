...
///////////////////////////////////////////////////// FUNCTION PROTOTYPES
//// PUBLIC
Putty_VarStruct *Putty_Init();  // Also returns a pointer to the variable struct
int Putty_GetErrorCode();       // Returns the error code
...
void Putty_Callback();          // Add it to a timer (or to the main loop)
// void Putty_UARTCallback(PuttyInterfaceTypeDef *pitd); // NOT USED!!! | Add it at HAL_UART_RxCpltCallback() | Called when data reception is finished
