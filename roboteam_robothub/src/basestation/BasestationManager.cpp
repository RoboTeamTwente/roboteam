...
namespace rtt::robothub::basestation {
    ...
    void BasestationManager::setFeedbackCallback(const std::function<void(const REM_RobotFeedback&, rtt::Team)>& callback) {
    ...
    void BasestationManager::setRobotStateInfoCallback(const std::function<void(const REM_RobotStateInfo&, rtt::Team)>& callback) {
        this->robotStateInfoCallbackFunction = callback;
    }

    void BasestationManager::setBasestationLogCallback(const std::function<void(const std::string&, rtt::Team)>& callback) {
        this->basestationLogCallback = callback;
    }
    ...
    FailedToInitializeLibUsb::FailedToInitializeLibUsb(const std::string& message)
        : message(message) {
    }
    const char* FailedToInitializeLibUsb::what() const noexcept {
