...
packets = {
    ...
    "REM_RobotStateInfo" : [
        ...
        ["filteredDribbleSpeed",	16, [0.     , 20000.], "filtered dribblerSpeed"],
        ["dribblespeedBeforeGotBall",	16, [0.     , 20000.], "dribblerSpeed at at the time dribbler thinks it got the ball"],
        ...
        ["bodyYawIntegral",		32, [-50000., 50000.], "Integral value from the PID for body_Yaw"],
        ["wheel1Integral",     	32, [-50000., 50000.], "Integral value from the PID for Wheel_1"],
        ["wheel2Integral",    	32, [-50000., 50000.], "Integral value from the PID for Wheel_2"],
        ["wheel3Integral",   		32, [-50000., 50000.], "Integral value from the PID for Wheel_3"],
        ["wheel4Integral",  		32, [-50000., 50000.], "Integral value from the PID for Wheel_4"]
    ],
    "REM_RobotBuzzer" : [
    	["header",              8,  None, "Header byte indicating the type of packet"],
        ["remVersion",          4,  None, "Version of roboteam_embedded_messages"],
