...
# ================================ GETTERS ================================
    ...
    def get_period(payload):
        return ((payload[8]) << 4) | ((payload[9] & 0b11110000) >> 4);

    @staticmethod
    def get_duration(payload):
        _duration = ((payload[9] & 0b00001111) << 12) | ((payload[10]) << 4) | ((payload[11] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_period(payload, period):
        payload[8] = (period >> 4);
        payload[9] = ((period << 4) & 0b11110000) | (payload[9] & 0b00001111);

    @staticmethod
    def set_duration(payload, duration):
        _duration = int(duration / 0.0000762951094835);
        payload[9] = ((_duration >> 12) & 0b00001111) | (payload[9] & 0b11110000);
        payload[10] = (_duration >> 4);
        payload[11] = ((_duration << 4) & 0b11110000) | (payload[11] & 0b00001111);
