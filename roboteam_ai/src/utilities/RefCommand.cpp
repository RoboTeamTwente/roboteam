...
std::string refCommandToString(RefCommand command){
    switch (command){
        case RefCommand::HALT:                  return "HALT";
        case RefCommand::STOP:                  return "STOP";
        case RefCommand::NORMAL_START:          return "NORMAL_START";
        case RefCommand::FORCED_START:          return "FORCED_START";
        case RefCommand::PREPARE_KICKOFF_US:    return "PREPARE_KICKOFF_US";
        case RefCommand::PREPARE_KICKOFF_THEM:  return "PREPARE_KICKOFF_THEM";
        case RefCommand::PREPARE_PENALTY_US:    return "PREPARE_PENALTY_US";
        case RefCommand::PREPARE_PENALTY_THEM:  return "PREPARE_PENALTY_THEM";
        case RefCommand::DIRECT_FREE_US:        return "DIRECT_FREE_US";
        case RefCommand::DIRECT_FREE_THEM:      return "DIRECT_FREE_THEM";
        case RefCommand::INDIRECT_FREE_US:      return "INDIRECT_FREE_US";
        case RefCommand::INDIRECT_FREE_THEM:    return "INDIRECT_FREE_THEM";
        case RefCommand::TIMEOUT_US:            return "TIMEOUT_US";
        case RefCommand::TIMEOUT_THEM:          return "TIMEOUT_THEM";
        case RefCommand::GOAL_US:               return "GOAL_US";
        case RefCommand::GOAL_THEM:             return "GOAL_THEM";
        case RefCommand::BALL_PLACEMENT_US:     return "BALL_PLACEMENT_US";
        case RefCommand::BALL_PLACEMENT_THEM:   return "BALL_PLACEMENT_THEM";
        case RefCommand::PRE_HALF:              return "PRE_HALF";
        case RefCommand::DO_KICKOFF:            return "DO_KICKOFF";
        case RefCommand::DEFEND_KICKOFF:        return "DEFEND_KICKOFF";
        case RefCommand::DO_PENALTY:            return "DO_PENALTY";
        case RefCommand::DEFEND_PENALTY:        return "DEFEND_PENALTY";
        case RefCommand::PREPARE_SHOOTOUT_US:   return "PREPARE_SHOOTOUT_US";
        case RefCommand::PREPARE_SHOOTOUT_THEM: return "PREPARE_SHOOTOUT_THEM";
        case RefCommand::DO_SHOOTOUT:           return "DO_SHOOTOUT";
        case RefCommand::DEFEND_SHOOTOUT:       return "DEFEND_SHOOTOUT";
        case RefCommand::UNDEFINED:             return "UNDEFINED";
        default:                                return "Warning: unknown RefCommand";
    }
}
...
std::string protoRefCommandToString(proto::SSL_Referee_Command command){
    switch(command){
        ...
        default:                                               return "Warning: unknown SSL_Referee_Command";
    }
}
...
std::string protoRefStageToString(proto::SSL_Referee_Stage stage){
    switch(stage){
        ...
        default:                                                  return "Warning: unknown SSL_Referee_Stage";
    }
}
