...
RobotFeedbackPublisher::RobotFeedbackPublisher():
    utils::Publisher<proto::RobotFeedback>(utils::ChannelType::ROBOT_FEEDBACK_PRIMARY_CHANNEL) {}

void RobotFeedbackPublisher::publish(const proto::RobotFeedback& feedback) {
    this->send(feedback);
}
