...
constexpr double MINIMUM_DISTANCE_BETWEEN_GOAL_AND_PLACEMENT =
    AVOID_BALL_DISTANCE + 2 * ROBOT_RADIUS + 0.4; /**< Minimum distance between the defense area and the ball placement position to be able to pass */
