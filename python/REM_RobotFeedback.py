...
# ================================ GETTERS ================================
    ...
    def get_batteryLevel(payload):
        return ((payload[12] & 0b11110000) >> 4);
    ...
    def get_capacitorCharged(payload):
        return (payload[12] & 0b00000100) > 0;

    @staticmethod
    def get_ballSensorWorking(payload):
        return (payload[12] & 0b00000010) > 0;

    @staticmethod
    def get_ballSensorSeesBall(payload):
        return (payload[12] & 0b00000001) > 0;

    @staticmethod
    def get_ballPos(payload):
        _ballPos = ((payload[13] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_batteryLevel(payload, batteryLevel):
        payload[12] = ((batteryLevel << 4) & 0b11110000) | (payload[12] & 0b00001111);

    @staticmethod
    def set_XsensCalibrated(payload, XsensCalibrated):
        payload[12] = ((XsensCalibrated << 3) & 0b00001000) | (payload[12] & 0b11110111);

    @staticmethod
    def set_capacitorCharged(payload, capacitorCharged):
        payload[12] = ((capacitorCharged << 2) & 0b00000100) | (payload[12] & 0b11111011);

    @staticmethod
    def set_ballSensorWorking(payload, ballSensorWorking):
        payload[12] = ((ballSensorWorking << 1) & 0b00000010) | (payload[12] & 0b11111101);

    @staticmethod
    def set_ballSensorSeesBall(payload, ballSensorSeesBall):
        payload[12] = (ballSensorSeesBall & 0b00000001) | (payload[12] & 0b11111110);

    @staticmethod
    def set_ballPos(payload, ballPos):
        _ballPos = int((ballPos +0.5000000000000000) / 0.0666666666666667);
        payload[13] = ((_ballPos << 4) & 0b11110000) | (payload[13] & 0b00001111);

    @staticmethod
    def set_dribblerSeesBall(payload, dribblerSeesBall):
        payload[13] = ((dribblerSeesBall << 3) & 0b00001000) | (payload[13] & 0b11110111);

    @staticmethod
    def set_reserved(payload, reserved):
        payload[13] = (reserved & 0b00000111) | (payload[13] & 0b11111000);

    @staticmethod
    def set_wheelLocked(payload, wheelLocked):
        payload[14] = ((wheelLocked << 4) & 0b11110000) | (payload[14] & 0b00001111);

    @staticmethod
    def set_wheelBraking(payload, wheelBraking):
        payload[14] = (wheelBraking & 0b00001111) | (payload[14] & 0b11110000);
