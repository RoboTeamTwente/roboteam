...
# ================================ GETTERS ================================
    ...
    def get_nextSong(payload):
        return (payload[7] & 0b00001000) > 0;

    @staticmethod
    def get_volume(payload):
        return ((payload[7] & 0b00000111) << 2) | ((payload[8] & 0b11000000) >> 6);
...
# ================================ SETTERS ================================
    ...
    def set_play(payload, play):
        payload[7] = ((play << 7) & 0b10000000) | (payload[7] & 0b01111111);

    @staticmethod
    def set_pause(payload, pause):
        payload[7] = ((pause << 6) & 0b01000000) | (payload[7] & 0b10111111);

    @staticmethod
    def set_stop(payload, stop):
        payload[7] = ((stop << 5) & 0b00100000) | (payload[7] & 0b11011111);

    @staticmethod
    def set_previousSong(payload, previousSong):
        payload[7] = ((previousSong << 4) & 0b00010000) | (payload[7] & 0b11101111);

    @staticmethod
    def set_nextSong(payload, nextSong):
        payload[7] = ((nextSong << 3) & 0b00001000) | (payload[7] & 0b11110111);

    @staticmethod
    def set_volume(payload, volume):
        payload[7] = ((volume >> 2) & 0b00000111) | (payload[7] & 0b11111000);
        payload[8] = ((volume << 6) & 0b11000000) | (payload[8] & 0b00111111);

    @staticmethod
    def set_volumeUp(payload, volumeUp):
        payload[8] = ((volumeUp << 5) & 0b00100000) | (payload[8] & 0b11011111);

    @staticmethod
    def set_volumeDown(payload, volumeDown):
        payload[8] = ((volumeDown << 4) & 0b00010000) | (payload[8] & 0b11101111);

    @staticmethod
    def set_folderId(payload, folderId):
        payload[8] = (folderId & 0b00001111) | (payload[8] & 0b11110000);
