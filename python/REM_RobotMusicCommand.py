...
# ================================ GETTERS ================================
    ...
    def get_pause(payload):
        return (payload[5] & 0b01000000) > 0;

    @staticmethod
    def get_stop(payload):
        return (payload[5] & 0b00100000) > 0;

    @staticmethod
    def get_previousSong(payload):
        return (payload[5] & 0b00010000) > 0;

    @staticmethod
    def get_nextSong(payload):
        return (payload[5] & 0b00001000) > 0;

    @staticmethod
    def get_volume(payload):
        return ((payload[5] & 0b00000111) << 2) | ((payload[6] & 0b11000000) >> 6);

    @staticmethod
    def get_volumeUp(payload):
        return (payload[6] & 0b00100000) > 0;

    @staticmethod
    def get_volumeDown(payload):
        return (payload[6] & 0b00010000) > 0;

    @staticmethod
    def get_folderId(payload):
        return ((payload[6] & 0b00001111));
...
# ================================ SETTERS ================================
    ...
    def set_play(payload, play):
        payload[5] = ((play << 7) & 0b10000000) | (payload[5] & 0b01111111);

    @staticmethod
    def set_pause(payload, pause):
        payload[5] = ((pause << 6) & 0b01000000) | (payload[5] & 0b10111111);

    @staticmethod
    def set_stop(payload, stop):
        payload[5] = ((stop << 5) & 0b00100000) | (payload[5] & 0b11011111);

    @staticmethod
    def set_previousSong(payload, previousSong):
        payload[5] = ((previousSong << 4) & 0b00010000) | (payload[5] & 0b11101111);

    @staticmethod
    def set_nextSong(payload, nextSong):
        payload[5] = ((nextSong << 3) & 0b00001000) | (payload[5] & 0b11110111);

    @staticmethod
    def set_volume(payload, volume):
        payload[5] = ((volume >> 2) & 0b00000111) | (payload[5] & 0b11111000);
        payload[6] = ((volume << 6) & 0b11000000) | (payload[6] & 0b00111111);

    @staticmethod
    def set_volumeUp(payload, volumeUp):
        payload[6] = ((volumeUp << 5) & 0b00100000) | (payload[6] & 0b11011111);

    @staticmethod
    def set_volumeDown(payload, volumeDown):
        payload[6] = ((volumeDown << 4) & 0b00010000) | (payload[6] & 0b11101111);

    @staticmethod
    def set_folderId(payload, folderId):
        payload[6] = (folderId & 0b00001111) | (payload[6] & 0b11110000);
