...
# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(BaseTypes.PACKET_SIZE_R_E_M__BASESTATION_SET_CONFIGURATION, dtype=np.uint8)
...
# ================================ DECODE ================================
    def decode(self, payload):
        ...
        self.channel          = REM_BasestationSetConfiguration.get_channel(payload)
