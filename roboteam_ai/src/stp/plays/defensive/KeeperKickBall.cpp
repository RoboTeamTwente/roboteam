...
void KeeperKickBall::calculateInfoForDefenders() noexcept {
    stpInfos["defender_left"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().topLeftCell().getPoints(), gen::SafePosition, field, world));
    stpInfos["defender_mid"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().middleLeftCell().getPoints(), gen::BlockingPosition, field, world));
    stpInfos["defender_right"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().bottomLeftCell().getPoints(), gen::SafePosition, field, world));
}

void KeeperKickBall::calculateInfoForMidfielders() noexcept {
    stpInfos["midfielder_left"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().topMiddleCell().getPoints(), gen::SafePosition, field, world));
    stpInfos["midfielder_mid"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().middleMiddleCell().getPoints(), gen::SafePosition, field, world));
    stpInfos["midfielder_right"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().bottomMiddleCell().getPoints(), gen::SafePosition, field, world));
}

void KeeperKickBall::calculateInfoForAttackers() noexcept {
    stpInfos["attacker_left"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().topRightCell().getPoints(), gen::SafePass, field, world));
    stpInfos["attacker_mid"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().middleRightCell().getPoints(), gen::SafePass, field, world));
    stpInfos["attacker_right"].setPositionToMoveTo(PositionComputations::getPosition(std::nullopt, field.getFieldGrid().bottomRightCell().getPoints(), gen::SafePass, field, world));
}
