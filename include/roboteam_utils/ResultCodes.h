...
constexpr uint8_t RESULT_SUCCESS = 0b00000000;
constexpr uint8_t RESULT_CLOSE = 0b00000001;
constexpr uint8_t RESULT_VELOCITY_DISREGARD = 0b00000010;
constexpr uint8_t RESULT_ORIENTATION_DISREGARD = 0b00000100;
constexpr uint8_t RESULT_FAIL_GOAL_OCCUPIED = 0b00001000;
constexpr uint8_t RESULT_FAIL_NO_PATH = 0b00010000;
constexpr uint8_t RESULT_FAIL_JAVA_EXCEPTION = 0b00100000;
constexpr uint8_t RESULT_FAIL_UNKOWN = 0b01000000;
constexpr uint8_t RESULT_FAIL = 0b10000000;
