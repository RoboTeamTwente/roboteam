...
static inline void RobotFeedback_set_rho(RobotFeedbackPayload *rfp, float rho){
    ...
    rfp->payload[4] = (_rho >> 4);
    rfp->payload[5] = ((_rho << 4) & 0b11110000) | (rfp->payload[5] & 0b00001111);
}
...
static inline void RobotFeedback_set_theta(RobotFeedbackPayload *rfp, float theta){
    ...
    rfp->payload[6] = (_theta >> 4);
    rfp->payload[7] = ((_theta << 4) & 0b11110000) | (rfp->payload[7] & 0b00001111);
}
...
static inline void RobotFeedback_set_angle(RobotFeedbackPayload *rfp, float angle){
    ...
    rfp->payload[8] = (_angle >> 4);
    rfp->payload[9] = ((_angle << 4) & 0b11110000) | (rfp->payload[9] & 0b00001111);
}
