...
#include <utility>
BallObservation::BallObservation(int cameraID, Time timeCaptured, Time timeSent, const proto::SSL_DetectionBall &detectionBall)
    : cameraID(cameraID),
...
BallObservation::BallObservation(int cameraID, Time timeCaptured, Time timeSent, Eigen::Vector2d position, Eigen::Vector2d pixelPosition, double confidence, uint32_t totalArea,
                                 double height)
    : cameraID{cameraID},
      timeCaptured{timeCaptured},
      timeSent{timeSent},
