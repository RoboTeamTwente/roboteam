...
# ================================ SETTERS ================================
    ...
    def set_angularVelocity(payload, angularVelocity):
        ...
        payload[12] = (_angularVelocity >> 8);
        payload[13] = _angularVelocity;

    @staticmethod
    def set_cameraAngle(payload, cameraAngle):
        _cameraAngle = int((cameraAngle +3.1415926535897931) / 0.0000958752621833);
        payload[14] = (_cameraAngle >> 8);
        payload[15] = _cameraAngle;

    @staticmethod
    def set_useCameraAngle(payload, useCameraAngle):
        payload[16] = ((useCameraAngle << 7) & 0b10000000) | (payload[16] & 0b01111111);

    @staticmethod
    def set_useAbsoluteAngle(payload, useAbsoluteAngle):
        payload[16] = ((useAbsoluteAngle << 6) & 0b01000000) | (payload[16] & 0b10111111);

    @staticmethod
    def set_dribbler(payload, dribbler):
        _dribbler = int(dribbler / 0.1428571428571428);
        payload[16] = ((_dribbler << 3) & 0b00111000) | (payload[16] & 0b11000111);

    @staticmethod
    def set_doKick(payload, doKick):
        payload[16] = ((doKick << 2) & 0b00000100) | (payload[16] & 0b11111011);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[16] = ((doChip << 1) & 0b00000010) | (payload[16] & 0b11111101);

    @staticmethod
    def set_kickAtAngle(payload, kickAtAngle):
        payload[16] = (kickAtAngle & 0b00000001) | (payload[16] & 0b11111110);

    @staticmethod
    def set_kickChipPower(payload, kickChipPower):
        _kickChipPower = int(kickChipPower / 0.4333333333333333);
        payload[17] = ((_kickChipPower << 4) & 0b11110000) | (payload[17] & 0b00001111);

    @staticmethod
    def set_doForce(payload, doForce):
        payload[17] = ((doForce << 3) & 0b00001000) | (payload[17] & 0b11110111);

    @staticmethod
    def set_feedback(payload, feedback):
        payload[17] = ((feedback << 2) & 0b00000100) | (payload[17] & 0b11111011);
