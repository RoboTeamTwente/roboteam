...
typedef enum _PACKET_TYPE { 
    ...
    PACKET_TYPE_RESERVED_1                     = 0b01101001,
    PACKET_TYPE_RESERVED_2                     = 0b11110000
} PACKET_TYPE;
...
typedef enum _PACKET_SIZE { 
    ...
    PACKET_SIZE_BASESTATION_STATISTICS         = 0,
    PACKET_SIZE_BASESTATION_ALERT              = 0,

    PACKET_SIZE_RESERVED_1                     = 0,
    PACKET_SIZE_RESERVED_2                     = 0
} PACKET_SIZE;
