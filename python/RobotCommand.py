...
# ================================ SETTERS ================================
    ...
    def set_rho(payload, rho):
        ...
        payload[3] = (_rho >> 4);
        payload[4] = ((_rho << 4) & 0b11110000) | (payload[4] & 0b00001111);
    ...
    def set_theta(payload, theta):
        ...
        payload[5] = (_theta >> 4);
        payload[6] = ((_theta << 4) & 0b11110000) | (payload[6] & 0b00001111);
    ...
    def set_angle(payload, angle):
        ...
        payload[7] = (_angle >> 4);
        payload[8] = ((_angle << 4) & 0b11110000) | (payload[8] & 0b00001111);
    ...
    def set_cameraAngle(payload, cameraAngle):
        ...
        payload[9] = (_cameraAngle >> 4);
        payload[10] = ((_cameraAngle << 4) & 0b11110000) | (payload[10] & 0b00001111);
    ...
    def set_kickChipPower(payload, kickChipPower):
        ...
        payload[11] = ((kickChipPower << 6) & 0b11000000) | (payload[11] & 0b00111111);
