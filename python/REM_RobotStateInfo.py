...
# ================================ SETTERS ================================
    ...
    def set_rateOfTurn(payload, rateOfTurn):
        ...
        payload[14] = ((_rateOfTurn >> 12) & 0b00001111) | (payload[14] & 0b11110000);
        payload[15] = (_rateOfTurn >> 4);
        payload[16] = ((_rateOfTurn << 4) & 0b11110000) | (payload[16] & 0b00001111);

    @staticmethod
    def set_wheelSpeed1(payload, wheelSpeed1):
        _wheelSpeed1 = int((wheelSpeed1 +1000.0000000000000000) / 0.0305180437933928);
        payload[16] = ((_wheelSpeed1 >> 12) & 0b00001111) | (payload[16] & 0b11110000);
        payload[17] = (_wheelSpeed1 >> 4);
        payload[18] = ((_wheelSpeed1 << 4) & 0b11110000) | (payload[18] & 0b00001111);

    @staticmethod
    def set_wheelSpeed2(payload, wheelSpeed2):
        _wheelSpeed2 = int((wheelSpeed2 +1000.0000000000000000) / 0.0305180437933928);
        payload[18] = ((_wheelSpeed2 >> 12) & 0b00001111) | (payload[18] & 0b11110000);
        payload[19] = (_wheelSpeed2 >> 4);
        payload[20] = ((_wheelSpeed2 << 4) & 0b11110000) | (payload[20] & 0b00001111);

    @staticmethod
    def set_wheelSpeed3(payload, wheelSpeed3):
        _wheelSpeed3 = int((wheelSpeed3 +1000.0000000000000000) / 0.0305180437933928);
        payload[20] = ((_wheelSpeed3 >> 12) & 0b00001111) | (payload[20] & 0b11110000);
        payload[21] = (_wheelSpeed3 >> 4);
        payload[22] = ((_wheelSpeed3 << 4) & 0b11110000) | (payload[22] & 0b00001111);

    @staticmethod
    def set_wheelSpeed4(payload, wheelSpeed4):
        _wheelSpeed4 = int((wheelSpeed4 +1000.0000000000000000) / 0.0305180437933928);
        payload[22] = ((_wheelSpeed4 >> 12) & 0b00001111) | (payload[22] & 0b11110000);
        payload[23] = (_wheelSpeed4 >> 4);
        payload[24] = ((_wheelSpeed4 << 4) & 0b11110000) | (payload[24] & 0b00001111);

    @staticmethod
    def set_dribbleSpeed(payload, dribbleSpeed):
        _dribbleSpeed = int(dribbleSpeed / 0.0762951094834821);
        payload[24] = ((_dribbleSpeed >> 12) & 0b00001111) | (payload[24] & 0b11110000);
        payload[25] = (_dribbleSpeed >> 4);
        payload[26] = ((_dribbleSpeed << 4) & 0b11110000) | (payload[26] & 0b00001111);
    ...
    def set_filteredDribbleSpeed(payload, filteredDribbleSpeed):
        ...
        payload[26] = ((_filteredDribbleSpeed >> 12) & 0b00001111) | (payload[26] & 0b11110000);
        payload[27] = (_filteredDribbleSpeed >> 4);
        payload[28] = ((_filteredDribbleSpeed << 4) & 0b11110000) | (payload[28] & 0b00001111);
    ...
    def set_dribblespeedBeforeGotBall(payload, dribblespeedBeforeGotBall):
        ...
        payload[28] = ((_dribblespeedBeforeGotBall >> 12) & 0b00001111) | (payload[28] & 0b11110000);
        payload[29] = (_dribblespeedBeforeGotBall >> 4);
        payload[30] = ((_dribblespeedBeforeGotBall << 4) & 0b11110000) | (payload[30] & 0b00001111);

    @staticmethod
    def set_bodyXIntegral(payload, bodyXIntegral):
        _bodyXIntegral = int((bodyXIntegral +5000.0000000000000000) / 0.1525902189669642);
        payload[30] = ((_bodyXIntegral >> 12) & 0b00001111) | (payload[30] & 0b11110000);
        payload[31] = (_bodyXIntegral >> 4);
        payload[32] = ((_bodyXIntegral << 4) & 0b11110000) | (payload[32] & 0b00001111);

    @staticmethod
    def set_bodyYIntegral(payload, bodyYIntegral):
        _bodyYIntegral = int((bodyYIntegral +5000.0000000000000000) / 0.1525902189669642);
        payload[32] = ((_bodyYIntegral >> 12) & 0b00001111) | (payload[32] & 0b11110000);
        payload[33] = (_bodyYIntegral >> 4);
        payload[34] = ((_bodyYIntegral << 4) & 0b11110000) | (payload[34] & 0b00001111);

    @staticmethod
    def set_bodyWIntegral(payload, bodyWIntegral):
        _bodyWIntegral = int((bodyWIntegral +5000.0000000000000000) / 0.1525902189669642);
        payload[34] = ((_bodyWIntegral >> 12) & 0b00001111) | (payload[34] & 0b11110000);
        payload[35] = (_bodyWIntegral >> 4);
        payload[36] = ((_bodyWIntegral << 4) & 0b11110000) | (payload[36] & 0b00001111);
    ...
    def set_bodyYawIntegral(payload, bodyYawIntegral):
        ...
        payload[36] = ((_bodyYawIntegral >> 12) & 0b00001111) | (payload[36] & 0b11110000);
        payload[37] = (_bodyYawIntegral >> 4);
    ...
    def set_wheel1Integral(payload, wheel1Integral):
        ...
        payload[38] = ((_wheel1Integral >> 12) & 0b00001111) | (payload[38] & 0b11110000);
        payload[39] = (_wheel1Integral >> 4);
        payload[40] = ((_wheel1Integral << 4) & 0b11110000) | (payload[40] & 0b00001111);

    @staticmethod
    def set_wheel2Integral(payload, wheel2Integral):
        _wheel2Integral = int((wheel2Integral +5000.0000000000000000) / 0.1525902189669642);
        payload[40] = ((_wheel2Integral >> 12) & 0b00001111) | (payload[40] & 0b11110000);
        payload[41] = (_wheel2Integral >> 4);
        payload[42] = ((_wheel2Integral << 4) & 0b11110000) | (payload[42] & 0b00001111);

    @staticmethod
    def set_wheel3Integral(payload, wheel3Integral):
        _wheel3Integral = int((wheel3Integral +5000.0000000000000000) / 0.1525902189669642);
        payload[42] = ((_wheel3Integral >> 12) & 0b00001111) | (payload[42] & 0b11110000);
        payload[43] = (_wheel3Integral >> 4);
        payload[44] = ((_wheel3Integral << 4) & 0b11110000) | (payload[44] & 0b00001111);

    @staticmethod
    def set_wheel4Integral(payload, wheel4Integral):
        _wheel4Integral = int((wheel4Integral +5000.0000000000000000) / 0.1525902189669642);
        payload[44] = ((_wheel4Integral >> 12) & 0b00001111) | (payload[44] & 0b11110000);
        payload[45] = (_wheel4Integral >> 4);
        payload[46] = ((_wheel4Integral << 4) & 0b11110000) | (payload[46] & 0b00001111);
