...
# ================================ GETTERS ================================
    ...
    def get_fillerBits(payload):
        return ((payload[5]) << 28) | ((payload[6]) << 20) | ((payload[7]) << 12) | ((payload[8]) << 4) | ((payload[9] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_fillerBits(payload, fillerBits):
        payload[5] = (fillerBits >> 28);
        payload[6] = (fillerBits >> 20);
        payload[7] = (fillerBits >> 12);
        payload[8] = (fillerBits >> 4);
        payload[9] = ((fillerBits << 4) & 0b11110000) | (payload[9] & 0b00001111);
