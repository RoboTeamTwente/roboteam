...
PACKET_TYPE_REM_GET_PIDGAINS                                 = 0b10100101 # 165 
PACKET_SIZE_REM_GET_PIDGAINS                                 = 2

PACKET_TYPE_REM_PIDGAINS                                     = 0b10101010 # 170 
PACKET_SIZE_REM_PIDGAINS                                     = 26
PACKET_RANGE_REM_PIDGAINS_PBODY_X_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_PBODY_X_MAX                        = 40.
PACKET_RANGE_REM_PIDGAINS_PBODY_X_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_IBODY_X_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_IBODY_X_MAX                        = 20.
PACKET_RANGE_REM_PIDGAINS_IBODY_X_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_DBODY_X_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_DBODY_X_MAX                        = 10.
PACKET_RANGE_REM_PIDGAINS_DBODY_X_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_PBODY_Y_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_PBODY_Y_MAX                        = 40.
PACKET_RANGE_REM_PIDGAINS_PBODY_Y_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_IBODY_Y_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_IBODY_Y_MAX                        = 20.
PACKET_RANGE_REM_PIDGAINS_IBODY_Y_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_DBODY_Y_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_DBODY_Y_MAX                        = 10.
PACKET_RANGE_REM_PIDGAINS_DBODY_Y_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_PBODY_YAW_MIN                      = 0.
PACKET_RANGE_REM_PIDGAINS_PBODY_YAW_MAX                      = 40.
PACKET_RANGE_REM_PIDGAINS_PBODY_YAW_N_BITS                   = 16
PACKET_RANGE_REM_PIDGAINS_IBODY_YAW_MIN                      = 0.
PACKET_RANGE_REM_PIDGAINS_IBODY_YAW_MAX                      = 20.
PACKET_RANGE_REM_PIDGAINS_IBODY_YAW_N_BITS                   = 16
PACKET_RANGE_REM_PIDGAINS_DBODY_YAW_MIN                      = 0.
PACKET_RANGE_REM_PIDGAINS_DBODY_YAW_MAX                      = 10.
PACKET_RANGE_REM_PIDGAINS_DBODY_YAW_N_BITS                   = 16
PACKET_RANGE_REM_PIDGAINS_PWHEELS_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_PWHEELS_MAX                        = 40.
PACKET_RANGE_REM_PIDGAINS_PWHEELS_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_IWHEELS_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_IWHEELS_MAX                        = 20.
PACKET_RANGE_REM_PIDGAINS_IWHEELS_N_BITS                     = 16
PACKET_RANGE_REM_PIDGAINS_DWHEELS_MIN                        = 0.
PACKET_RANGE_REM_PIDGAINS_DWHEELS_MAX                        = 10.
PACKET_RANGE_REM_PIDGAINS_DWHEELS_N_BITS                     = 16
