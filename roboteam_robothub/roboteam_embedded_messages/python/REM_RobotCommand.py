...
# ================================ GETTERS ================================
    ...
    def get_dribbler(payload):
        _dribbler = ((payload[18] & 0b00111000) >> 3);
    ...
    def get_kickChipPower(payload):
        _kickChipPower = ((payload[19] & 0b11110000) >> 4);
        return (_kickChipPower * 0.4333333333333333);

    @staticmethod
    def get_doForce(payload):
        return (payload[19] & 0b00001000) > 0;

    @staticmethod
    def get_feedback(payload):
        return (payload[19] & 0b00000100) > 0;
...
# ================================ SETTERS ================================
    ...
    def set_angularVelocity(payload, angularVelocity):
        ...
        payload[14] = (_angularVelocity >> 8);
        payload[15] = _angularVelocity;

    @staticmethod
    def set_cameraAngle(payload, cameraAngle):
        _cameraAngle = int((cameraAngle +3.1415926535897931) / 0.0000958752621833);
        payload[16] = (_cameraAngle >> 8);
        payload[17] = _cameraAngle;

    @staticmethod
    def set_useCameraAngle(payload, useCameraAngle):
        payload[18] = ((useCameraAngle << 7) & 0b10000000) | (payload[18] & 0b01111111);

    @staticmethod
    def set_useAbsoluteAngle(payload, useAbsoluteAngle):
        payload[18] = ((useAbsoluteAngle << 6) & 0b01000000) | (payload[18] & 0b10111111);

    @staticmethod
    def set_dribbler(payload, dribbler):
        _dribbler = int(dribbler / 0.1428571428571428);
        payload[18] = ((_dribbler << 3) & 0b00111000) | (payload[18] & 0b11000111);

    @staticmethod
    def set_doKick(payload, doKick):
        payload[18] = ((doKick << 2) & 0b00000100) | (payload[18] & 0b11111011);

    @staticmethod
    def set_doChip(payload, doChip):
        payload[18] = ((doChip << 1) & 0b00000010) | (payload[18] & 0b11111101);

    @staticmethod
    def set_kickAtAngle(payload, kickAtAngle):
        payload[18] = (kickAtAngle & 0b00000001) | (payload[18] & 0b11111110);

    @staticmethod
    def set_kickChipPower(payload, kickChipPower):
        _kickChipPower = int(kickChipPower / 0.4333333333333333);
        payload[19] = ((_kickChipPower << 4) & 0b11110000) | (payload[19] & 0b00001111);

    @staticmethod
    def set_doForce(payload, doForce):
        payload[19] = ((doForce << 3) & 0b00001000) | (payload[19] & 0b11110111);

    @staticmethod
    def set_feedback(payload, feedback):
        payload[19] = ((feedback << 2) & 0b00000100) | (payload[19] & 0b11111011);
