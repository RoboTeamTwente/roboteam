...
// Generated on October 29 2020, 14:10:08
...
static inline void RobotFeedback_set_rho(RobotFeedbackPayload *rfp, float _rho){
    uint16_t rho = (_rho - -3.1415926535897931) * 10430.3783504704533698;
    rfp->payload[3] = (rho >> 8);
    rfp->payload[4] = rho;
}
static inline void RobotFeedback_set_theta(RobotFeedbackPayload *rfp, float _theta){
    uint16_t theta = (_theta - -5.0000000000000000) * 6553.6000000000003638;
