...
/**
 * @brief Rotates all relevant fields of the wrapper packet (robots, ball and geometry)
 * @param packet
 */
void rotate(proto::SSL_WrapperPacket *packet);

/**
 * @brief rotates all relevant fields of the detection frame (robots and ball)
 * @param packet
 */
void rotate(proto::SSL_DetectionFrame *frame);

/**
 * @brief Rotates a detection robot
 */
void rotate(proto::SSL_DetectionRobot *robot);

/**
 * @brief Rotates a detection ball
 * @param ball
 */
