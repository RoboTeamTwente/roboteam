...
class Out {
   public:
    ...
    static void refereeData(const proto::SSL_Referee& refereeData);
     ...
     */
    static void consumeData(std::function<void(const proto::MsgToInterface::DataBuffer& data)> consumer);
   ...
   private:
    ...
    static proto::MsgToInterface::DataBuffer * data;
