...
static inline bool REM_RobotFeedback_get_capacitorCharged(REM_RobotFeedbackPayload *remrfp){
    return (remrfp->payload[3] & 0b00001000) > 0;
}

static inline float REM_RobotFeedback_get_ballPos(REM_RobotFeedbackPayload *remrfp){
    uint32_t _ballPos = ((remrfp->payload[3] & 0b00000111) << 1) | ((remrfp->payload[4] & 0b10000000) >> 7);
...
static inline float REM_RobotFeedback_get_rho(REM_RobotFeedbackPayload *remrfp){
    uint32_t _rho = ((remrfp->payload[4] & 0b01111111) << 9) | ((remrfp->payload[5]) << 1) | ((remrfp->payload[6] & 0b10000000) >> 7);
...
static inline float REM_RobotFeedback_get_theta(REM_RobotFeedbackPayload *remrfp){
    uint32_t _theta = ((remrfp->payload[6] & 0b01111111) << 9) | ((remrfp->payload[7]) << 1) | ((remrfp->payload[8] & 0b10000000) >> 7);
...
static inline float REM_RobotFeedback_get_angle(REM_RobotFeedbackPayload *remrfp){
    uint32_t _angle = ((remrfp->payload[8] & 0b01111111) << 9) | ((remrfp->payload[9]) << 1) | ((remrfp->payload[10] & 0b10000000) >> 7);
...
static inline uint32_t REM_RobotFeedback_get_wheelLocked(REM_RobotFeedbackPayload *remrfp){
    return ((remrfp->payload[10] & 0b01111000) >> 3);
}

static inline uint32_t REM_RobotFeedback_get_wheelBraking(REM_RobotFeedbackPayload *remrfp){
    return ((remrfp->payload[10] & 0b00000111) << 1) | ((remrfp->payload[11] & 0b10000000) >> 7);
}

static inline uint32_t REM_RobotFeedback_get_rssi(REM_RobotFeedbackPayload *remrfp){
    return ((remrfp->payload[11] & 0b01111111) << 1) | ((remrfp->payload[12] & 0b10000000) >> 7);
}
...
static inline void REM_RobotFeedback_set_ballSensorSeesBall(REM_RobotFeedbackPayload *remrfp, bool ballSensorSeesBall){
    remrfp->payload[3] = ((ballSensorSeesBall << 5) & 0b00100000) | (remrfp->payload[3] & 0b11011111);
}

static inline void REM_RobotFeedback_set_dribblerSeesBall(REM_RobotFeedbackPayload *remrfp, bool dribblerSeesBall){
    remrfp->payload[3] = ((dribblerSeesBall << 4) & 0b00010000) | (remrfp->payload[3] & 0b11101111);
}

static inline void REM_RobotFeedback_set_capacitorCharged(REM_RobotFeedbackPayload *remrfp, bool capacitorCharged){
    remrfp->payload[3] = ((capacitorCharged << 3) & 0b00001000) | (remrfp->payload[3] & 0b11110111);
}
...
static inline void REM_RobotFeedback_set_ballPos(REM_RobotFeedbackPayload *remrfp, float ballPos){
    ...
    remrfp->payload[3] = ((_ballPos >> 1) & 0b00000111) | (remrfp->payload[3] & 0b11111000);
    remrfp->payload[4] = ((_ballPos << 7) & 0b10000000) | (remrfp->payload[4] & 0b01111111);
}
...
static inline void REM_RobotFeedback_set_rho(REM_RobotFeedbackPayload *remrfp, float rho){
    ...
    remrfp->payload[4] = ((_rho >> 9) & 0b01111111) | (remrfp->payload[4] & 0b10000000);
    remrfp->payload[5] = (_rho >> 1);
    remrfp->payload[6] = ((_rho << 7) & 0b10000000) | (remrfp->payload[6] & 0b01111111);
}
...
static inline void REM_RobotFeedback_set_theta(REM_RobotFeedbackPayload *remrfp, float theta){
    ...
    remrfp->payload[6] = ((_theta >> 9) & 0b01111111) | (remrfp->payload[6] & 0b10000000);
    remrfp->payload[7] = (_theta >> 1);
    remrfp->payload[8] = ((_theta << 7) & 0b10000000) | (remrfp->payload[8] & 0b01111111);
}
...
static inline void REM_RobotFeedback_set_angle(REM_RobotFeedbackPayload *remrfp, float angle){
    ...
    remrfp->payload[8] = ((_angle >> 9) & 0b01111111) | (remrfp->payload[8] & 0b10000000);
    remrfp->payload[9] = (_angle >> 1);
    remrfp->payload[10] = ((_angle << 7) & 0b10000000) | (remrfp->payload[10] & 0b01111111);
}

static inline void REM_RobotFeedback_set_wheelLocked(REM_RobotFeedbackPayload *remrfp, uint32_t wheelLocked){
    remrfp->payload[10] = ((wheelLocked << 3) & 0b01111000) | (remrfp->payload[10] & 0b10000111);
}

static inline void REM_RobotFeedback_set_wheelBraking(REM_RobotFeedbackPayload *remrfp, uint32_t wheelBraking){
    remrfp->payload[10] = ((wheelBraking >> 1) & 0b00000111) | (remrfp->payload[10] & 0b11111000);
    remrfp->payload[11] = ((wheelBraking << 7) & 0b10000000) | (remrfp->payload[11] & 0b01111111);
}

static inline void REM_RobotFeedback_set_rssi(REM_RobotFeedbackPayload *remrfp, uint32_t rssi){
    remrfp->payload[11] = ((rssi >> 1) & 0b01111111) | (remrfp->payload[11] & 0b10000000);
    remrfp->payload[12] = ((rssi << 7) & 0b10000000) | (remrfp->payload[12] & 0b01111111);
}
