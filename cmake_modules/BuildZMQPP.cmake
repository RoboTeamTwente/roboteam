...
ExternalProject_Add(project_zmqpp
        ...
        -DCMAKE_INSTALL_PREFIX=${CMAKE_CURRENT_BINARY_DIR}/zmqpp
...
add_dependencies(lib::zmqpp project_zmqpp)
set_target_properties(lib::zmqpp PROPERTIES IMPORTED_LOCATION ${CMAKE_CURRENT_BINARY_DIR}/zmqpp/lib/libzmqpp-static.a)
target_link_libraries(lib::zmqpp
        INTERFACE lib::zmq)
target_include_directories(lib::zmqpp
        INTERFACE ${CMAKE_CURRENT_BINARY_DIR}/zmqpp/include)