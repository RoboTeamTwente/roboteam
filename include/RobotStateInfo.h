...
static inline float RobotStateInfo_get_xsensAcc1(RobotStateInfoPayload *rsip){
    _xsensAcc1 = ((rsip->payload[2]) << 24) | ((rsip->payload[3]) << 16) | ((rsip->payload[4]) << 8) | ((rsip->payload[5]));
...
static inline float RobotStateInfo_get_xsensAcc2(RobotStateInfoPayload *rsip){
    _xsensAcc2 = ((rsip->payload[6]) << 24) | ((rsip->payload[7]) << 16) | ((rsip->payload[8]) << 8) | ((rsip->payload[9]));
...
static inline float RobotStateInfo_get_xsensYaw(RobotStateInfoPayload *rsip){
    _xsensYaw = ((rsip->payload[10]) << 24) | ((rsip->payload[11]) << 16) | ((rsip->payload[12]) << 8) | ((rsip->payload[13]));
...
static inline float RobotStateInfo_get_rateOfTurn(RobotStateInfoPayload *rsip){
    _rateOfTurn = ((rsip->payload[14]) << 24) | ((rsip->payload[15]) << 16) | ((rsip->payload[16]) << 8) | ((rsip->payload[17]));
...
static inline float RobotStateInfo_get_wheelSpeed1(RobotStateInfoPayload *rsip){
    _wheelSpeed1 = ((rsip->payload[18]) << 24) | ((rsip->payload[19]) << 16) | ((rsip->payload[20]) << 8) | ((rsip->payload[21]));
...
static inline float RobotStateInfo_get_wheelSpeed2(RobotStateInfoPayload *rsip){
    _wheelSpeed2 = ((rsip->payload[22]) << 24) | ((rsip->payload[23]) << 16) | ((rsip->payload[24]) << 8) | ((rsip->payload[25]));
...
static inline float RobotStateInfo_get_wheelSpeed3(RobotStateInfoPayload *rsip){
    _wheelSpeed3 = ((rsip->payload[26]) << 24) | ((rsip->payload[27]) << 16) | ((rsip->payload[28]) << 8) | ((rsip->payload[29]));
...
static inline float RobotStateInfo_get_wheelSpeed4(RobotStateInfoPayload *rsip){
    _wheelSpeed4 = ((rsip->payload[30]) << 24) | ((rsip->payload[31]) << 16) | ((rsip->payload[32]) << 8) | ((rsip->payload[33]));
