...
static inline void REM_BasestationGetConfiguration_set_timestamp(REM_BasestationGetConfigurationPayload *rembgcp, uint32_t timestamp){
    rembgcp->payload[4] = (timestamp >> 8);
    rembgcp->payload[5] = timestamp;
}
