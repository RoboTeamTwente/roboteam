...
public:
     ...
     * @return double angle
     */
    double angleDiff(Angle const& other) const noexcept;
     ...
     */
    double angleDiff(double other) const noexcept;
     ...
     * @return double 
     */
    double shortestAngleDiff(Angle const &other) const noexcept;
     ...
     */
    rtt::Vector2 toVector2(double length = 1.0) const noexcept;
