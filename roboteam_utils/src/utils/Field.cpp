...
bool Field::operator==(const Field& other) const {
    return this->leftPenaltyPoint == other.leftPenaltyPoint && this->rightPenaltyPoint == other.rightPenaltyPoint && this->centerCircle == other.centerCircle &&
           this->boundaryWidth == other.boundaryWidth && this->playArea == other.playArea && this->leftPlayArea == other.leftPlayArea &&
           this->rightPlayArea == other.rightPlayArea && this->leftDefenseArea == other.leftDefenseArea && this->rightDefenseArea == other.rightDefenseArea &&
           this->leftGoalArea == other.leftGoalArea && this->rightGoalArea == other.rightGoalArea && this->bottomLeftGrid == other.bottomLeftGrid &&
           this->bottomMidGrid == other.bottomMidGrid && this->bottomRightGrid == other.bottomRightGrid && this->middleLeftGrid == other.middleLeftGrid &&
           this->middleMidGrid == other.middleMidGrid && this->middleRightGrid == other.middleRightGrid && this->topLeftGrid == other.topLeftGrid &&
           this->topMidGrid == other.topMidGrid && this->topRightGrid == other.topRightGrid;
}

Field Field::createField(double fieldWidth, double fieldHeight, double defenseWidth, double defenseHeight, double goalWidth, double goalHeight, double boundaryWidth,
