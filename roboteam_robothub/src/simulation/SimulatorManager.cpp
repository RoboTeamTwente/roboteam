...
namespace rtt::robothub::simulation {
    ...
    SimulatorManager::~SimulatorManager() {
        this->stopFeedbackListeningThreads();
    }
    ...
    void SimulatorManager::setRobotControlFeedbackCallback(std::function<void(RobotControlFeedback&)> callback) {
        this->robotControlFeedbackCallback = callback;
    }
    void SimulatorManager::setConfigurationFeedbackCallback(std::function<void(ConfigurationFeedback&)> callback) {
        this->configurationFeedbackCallback = callback;
    }
    ...
    FailedToBindPortException::FailedToBindPortException(const std::string message) {
        this->message = message;
    }

    const char* FailedToBindPortException::what() const noexcept {
