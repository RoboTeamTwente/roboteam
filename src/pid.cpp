...
PID::PID(std::tuple<double, double, double, double> pidf) : PID(std::get<0>(pidf), std::get<1>(pidf), std::get<2>(pidf), std::get<3>(pidf)) {}
...
void PID::setPID(std::tuple<double, double, double> pid) { this->setPID(std::get<0>(pid), std::get<1>(pid), std::get<2>(pid)); }

void PID::setPID(std::tuple<double, double, double> pid, double f) { this->setPID(std::get<0>(pid), std::get<1>(pid), std::get<2>(pid), f); }
