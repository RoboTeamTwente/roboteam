...
/* minX 0, minY 0, maxX 700, maxY 440, minSize 100, reported&tracked touch 1, everything else off */
...
uint8_t config_response[] = {0xEF, 0x43, 0x40, 0x02, 0x02, 0x00, 0x73, 0x3D, 0xA2, 0x1D,
		0x80, 0x01, 0x24, 0x81, 0x01, 0x00, 0x82, 0x02, 0x02, 0xBC, 0x83, 0x02, 0x01, 0xB8,
		0x84, 0x01, 0x00, 0x85, 0x01, 0x00, 0x86, 0x01, 0x00, 0x87, 0x01, 0x00, 0x88, 0x01, 0x00, 0xA4, 0x0C,
		0x80, 0x01, 0x00, 0x81, 0x01, 0x00, 0x82, 0x01, 0x00, 0x83, 0x01, 0x00, 0x85, 0x01, 0x00,
		0x86, 0x01, 0x01, 0xA7, 0x08, 0x80, 0x02, 0x02, 0x98, 0x81, 0x02, 0x01, 0xB8};

//uint8_t config_command[] = {0xEE, 0x2C, 0x40, 0x02, 0x02, 0x00, 0x73, 0x26, 0x80, 0x01, 0x01, 0xA2, 0x0E, 0x80, 0x01, 0x00, 0x81, 0x01, 0x00, 0x82, 0x02, 0x02, 0xBC, 0x83, 0x02, 0x01, 0xB8, 0xA4, 0x06, 0x82, 0x01, 0xFF, 0x83, 0x01, 0x64, 0x86, 0x01, 0x01, 0xA7, 0x06, 0x80, 0x01, 0x00, 0x81, 0x01, 0x00};
//uint8_t config_response[] = {0xEF, 0x3C, 0x40, 0x02, 0x02, 0x00, 0x73, 0x36, 0x80, 0x01, 0x01, 0xA2,
//		0x17, 0x80, 0x01, 0x00, 0x81, 0x01, 0x00, 0x82, 0x02, 0x02, 0xBC, 0x83,
//		0x02, 0x01, 0xB8, 0x84, 0x01, 0x00, 0x85, 0x01, 0x00, 0x86, 0x01, 0x00,
//		0xA4, 0x0D, 0x80, 0x01, 0xFF, 0x81, 0x02, 0x03, 0xE8, 0x82, 0x01, 0xFF,
//		0x83, 0x01, 0x64, 0x86, 0x01, 0x01, 0xA7, 0x06, 0x80, 0x01, 0x00, 0x81,
//		0x01, 0x00};


/* ball sensor frequency command */
/* set scanning frequency to 800Hz (0x3, 0x20) & idle frequency to 800Hz */
uint8_t freq_command[] = {0xEE, 0x10, 0xEE, 0x0E, 0x40, 0x02, 0x02, 0x00, 0x68, 0x08, 0x80, 0x02, 0x02, 0x58, 0x82, 0x02, 0x02, 0x58};
uint8_t freq_response[] = {0xEF, 0x0E, 0x40, 0x02, 0x00, 0x00, 0x68, 0x08, 0x80, 0x02, 0x02, 0x58, 0x82, 0x02, 0x02, 0x58};
...
//        else { // disable this else block to only report canSeeBall and canKickBall
			...
			if (ball_debug == 1) Putty_printf ("y=%d, x=%d\n\r", ballPosition.y, ballPosition.x);
	   ...
	   * (config) ? zForce_SetFreq :
	   * OR (freq) ? zForce_EnableDevice :
