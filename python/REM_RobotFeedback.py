...
# ================================ GETTERS ================================
    ...
    def get_XsensCalibrated(payload):
        return (payload[11] & 0b00001000) > 0;

    @staticmethod
    def get_capacitorCharged(payload):
        return (payload[11] & 0b00000100) > 0;
    ...
    def get_ballPos(payload):
        _ballPos = ((payload[12] & 0b11110000) >> 4);
...
# ================================ SETTERS ================================
    ...
    def set_batteryLevel(payload, batteryLevel):
        payload[11] = ((batteryLevel << 4) & 0b11110000) | (payload[11] & 0b00001111);

    @staticmethod
    def set_XsensCalibrated(payload, XsensCalibrated):
        payload[11] = ((XsensCalibrated << 3) & 0b00001000) | (payload[11] & 0b11110111);

    @staticmethod
    def set_capacitorCharged(payload, capacitorCharged):
        payload[11] = ((capacitorCharged << 2) & 0b00000100) | (payload[11] & 0b11111011);

    @staticmethod
    def set_ballSensorWorking(payload, ballSensorWorking):
        payload[11] = ((ballSensorWorking << 1) & 0b00000010) | (payload[11] & 0b11111101);

    @staticmethod
    def set_ballSensorSeesBall(payload, ballSensorSeesBall):
        payload[11] = (ballSensorSeesBall & 0b00000001) | (payload[11] & 0b11111110);

    @staticmethod
    def set_ballPos(payload, ballPos):
        _ballPos = int((ballPos +0.5000000000000000) / 0.0666666666666667);
        payload[12] = ((_ballPos << 4) & 0b11110000) | (payload[12] & 0b00001111);
    ...
    def set_wheelLocked(payload, wheelLocked):
        payload[13] = ((wheelLocked << 4) & 0b11110000) | (payload[13] & 0b00001111);

    @staticmethod
    def set_wheelBraking(payload, wheelBraking):
        payload[13] = (wheelBraking & 0b00001111) | (payload[13] & 0b11110000);
