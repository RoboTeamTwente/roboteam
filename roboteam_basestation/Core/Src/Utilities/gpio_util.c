...
const GPIO_Pin LD_3 				= { LD3_GPIO_Port				, LD3_Pin				};
const GPIO_Pin LD_2 				= { LD2_GPIO_Port				, LD2_Pin				};
const GPIO_Pin LD_ACTIVE 			= { LD_ACTIVE_GPIO_Port			, LD_ACTIVE_Pin			};
const GPIO_Pin LD_USB 			    = { LD_USB_GPIO_Port			, LD_USB_Pin			};
const GPIO_Pin LD_LED1 			    = { LD_LED1_GPIO_Port			, LD_LED1_Pin			};
const GPIO_Pin LD_LED2 			    = { LD_LED2_GPIO_Port			, LD_LED2_Pin			};
const GPIO_Pin LD_LED3 			    = { LD_LED3_GPIO_Port			, LD_LED3_Pin			};
