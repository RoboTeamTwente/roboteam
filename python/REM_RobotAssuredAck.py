...
# ================================ SETTERS ================================
    ...
    def set_sequenceNumber(payload, sequenceNumber):
        payload[7] = sequenceNumber;

# ================================ ENCODE ================================
    def encode(self):
        payload = np.zeros(REM_BaseTypes.REM_PACKET_SIZE_REM_ROBOT_ASSURED_ACK, dtype=np.uint8)
        REM_RobotAssuredAck.set_header              (payload, self.header)
        REM_RobotAssuredAck.set_toRobotId           (payload, self.toRobotId)
        REM_RobotAssuredAck.set_toColor             (payload, self.toColor)
        REM_RobotAssuredAck.set_toBC                (payload, self.toBC)
        REM_RobotAssuredAck.set_toBS                (payload, self.toBS)
        REM_RobotAssuredAck.set_toPC                (payload, self.toPC)
        REM_RobotAssuredAck.set_fromRobotId         (payload, self.fromRobotId)
        REM_RobotAssuredAck.set_fromColor           (payload, self.fromColor)
        REM_RobotAssuredAck.set_reserved            (payload, self.reserved)
        REM_RobotAssuredAck.set_fromBS              (payload, self.fromBS)
        REM_RobotAssuredAck.set_fromPC              (payload, self.fromPC)
        REM_RobotAssuredAck.set_remVersion          (payload, self.remVersion)
        REM_RobotAssuredAck.set_messageId           (payload, self.messageId)
        REM_RobotAssuredAck.set_timestamp           (payload, self.timestamp)
        REM_RobotAssuredAck.set_payloadSize         (payload, self.payloadSize)
...
# ================================ DECODE ================================
    def decode(self, payload):
        ...
        self.toRobotId        = REM_RobotAssuredAck.get_toRobotId(payload)
        self.toColor          = REM_RobotAssuredAck.get_toColor(payload)
        self.toBC             = REM_RobotAssuredAck.get_toBC(payload)
        self.toBS             = REM_RobotAssuredAck.get_toBS(payload)
        self.toPC             = REM_RobotAssuredAck.get_toPC(payload)
        self.fromRobotId      = REM_RobotAssuredAck.get_fromRobotId(payload)
        self.fromColor        = REM_RobotAssuredAck.get_fromColor(payload)
        self.reserved         = REM_RobotAssuredAck.get_reserved(payload)
        self.fromBS           = REM_RobotAssuredAck.get_fromBS(payload)
        self.fromPC           = REM_RobotAssuredAck.get_fromPC(payload)
        self.remVersion       = REM_RobotAssuredAck.get_remVersion(payload)
        self.messageId        = REM_RobotAssuredAck.get_messageId(payload)
        self.timestamp        = REM_RobotAssuredAck.get_timestamp(payload)
        self.payloadSize      = REM_RobotAssuredAck.get_payloadSize(payload)
