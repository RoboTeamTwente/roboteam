...
namespace rtt {
    ...
    Vector2
    Cone::LineIntersection(Vector2 line1Start, Vector2 line1Dir, Vector2 line2Start, Vector2 line2Dir) noexcept {
        float slope1 = line1Dir.y / line1Dir.x;
        float slope2 = line2Dir.y / line2Dir.x;
        float intersectX =
                (slope1 * line1Start.x - slope2 * line2Start.x - line1Start.y + line2Start.y) / (slope1 - slope2);
    ...
    bool Cone::DoConesOverlap(Cone otherCone) const noexcept {
        return this->IsWithinCone(otherCone.side1 + otherCone.start) ||
               this->IsWithinCone(otherCone.side2 + otherCone.start) || otherCone.IsWithinCone(side1 + start) ||
    ...
    Cone Cone::MergeCones(Cone otherCone) const noexcept {
        ...
        if (this->IsWithinCone(otherCone.side1 + otherCone.start) &&
            this->IsWithinCone(otherCone.side2 + otherCone.start)) {
            return *this;
        }
