...
/**
 * @brief Class that evaluates the kick off them prepare game state
 */
class KickOffThemPrepareGameStateEvaluation : public BaseEvaluation {
   public:
    /**
     * @brief Calculates the score for the kick off them prepare game state
     * @param world The current world
     * @param field The current field
     * @return The score of the kick off them prepare game state
     */
