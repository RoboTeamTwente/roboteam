...
namespace rtt {
    ...
    int Grid::getNumPointsX() const {
        return numPointsX;
    }

    int Grid::getNumPointsY() const {
        return numPointsY;
    }
    ...
    bool Grid::operator==(const Grid &other) const {
        return this->getOffSetX() == other.getOffSetX() && this->getOffSetY() == other.getOffSetY() && this->getRegionWidth() == other.getRegionWidth() && this->getRegionHeight() == other.getRegionHeight() && this->getNumPointsX() == other.getNumPointsX() && this->getNumPointsY() == other.getNumPointsY();
    }
