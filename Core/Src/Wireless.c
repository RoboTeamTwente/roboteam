...
SX1280_Settings set = {
        ...
        .periodBaseCount = 24,
		.syncWords = {0x39CE75CE, 0, 0},
        .syncWordSensitivity = 1,
        .TXoffset = 128,
        .RXoffset = 0,
        .ModParam = {FLRC_BR_1_300_BW_1_2, FLRC_CR_1_0, BT_0_5},
        .PacketParam = {PREAMBLE_LENGTH_16_BITS, FLRC_SYNC_WORD_LEN_P32S, RX_MATCH_SYNC_WORD_1, PACKET_FIXED_LENGTH, RECEIVEPKTLEN, CRC_OFF, NO_WHITENING},
