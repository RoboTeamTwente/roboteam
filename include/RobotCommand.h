...
static inline void RobotCommand_set_kickChipPower(RobotCommandPayload *rcp, uint32_t kickChipPower){
    ...
    rcp->payload[11] = ((kickChipPower << 5) & 0b11000000) | (rcp->payload[11] & 0b00111111);
}
